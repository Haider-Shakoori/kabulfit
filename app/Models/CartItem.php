...
class CartItem extends Model {
 ...
 public function unitPriceMinor(): int{return $this->variant?->currentPriceMinor() ?? $this->product->currentPriceMinor();}
 public function lineTotalMinor(): int{return $this->unitPriceMinor()*$this->quantity;}
}